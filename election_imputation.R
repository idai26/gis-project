...
#   - MN-shapefiles/MN16/mn_precincts16.shp (2016 boundaries - use for 2013, 2017, 2018)
#   - mpls_precincts_2021/general_election_results_by_precinct_2020.shp (2020 boundaries - use for 2020, 2021)
#   - mpls_precincts_2025/bdry_votingdistricts.shp (2025 boundaries - use for 2022, 2024, 2025)

# Election results are now split into two files:
#   - election_results/election_results_13_21.csv (2013-2021, uses pctlabels_2010s.csv)
#   - election_results/election_results_22_25.csv (2022-2025, uses pctlabels_2020s.csv)
#
...
election_config <- tribble(
  ...
  "hodges13", 2013, "2013 Mayoral - Hodges", "MN-shapefiles/MN16/mn_precincts16.shp", "hodges13_votes", "13_21",
  "winton13", 2013, "2013 Mayoral - Winton", "MN-shapefiles/MN16/mn_precincts16.shp", "winton13_votes", "13_21",
  "samuels13", 2013, "2013 Mayoral - Samuels", "MN-shapefiles/MN16/mn_precincts16.shp", "samuels13_votes", "13_21",
  "andrew13", 2013, "2013 Mayoral - Andrew", "MN-shapefiles/MN16/mn_precincts16.shp", "andrew13_votes", "13_21",
  "mayor_13_total", 2013, "2013 Mayoral - Total", "MN-shapefiles/MN16/mn_precincts16.shp", "mayor_13_total", "13_21",
  
  # 2017 Mayoral (use 2016 shapefile)
  "hodges17", 2017, "2017 Mayoral - Hodges", "MN-shapefiles/MN16/mn_precincts16.shp", "hodges17_votes", "13_21",
  "frey17", 2017, "2017 Mayoral - Frey", "MN-shapefiles/MN16/mn_precincts16.shp", "frey17_votes", "13_21",
  "levy17", 2017, "2017 Mayoral - Levy", "MN-shapefiles/MN16/mn_precincts16.shp", "levy17_votes", "13_21",
  "dehn17", 2017, "2017 Mayoral - Dehn", "MN-shapefiles/MN16/mn_precincts16.shp", "dehn17_votes", "13_21",
  "hoch17", 2017, "2017 Mayoral - Hoch", "MN-shapefiles/MN16/mn_precincts16.shp", "hoch17_votes", "13_21",
  "mayor_17_total", 2017, "2017 Mayoral - Total", "MN-shapefiles/MN16/mn_precincts16.shp", "mayor_17_total", "13_21",
  
  # 2018 Governor (use 2016 shapefile)
  "murphy18", 2018, "2018 Governor - Murphy", "MN-shapefiles/MN16/mn_precincts16.shp", "murphy18_votes", "13_21",
  "swanson18", 2018, "2018 Governor - Swanson", "MN-shapefiles/MN16/mn_precincts16.shp", "swanson18_votes", "13_21",
  "walz18", 2018, "2018 Governor - Walz", "MN-shapefiles/MN16/mn_precincts16.shp", "walz18_votes", "13_21",
  "gov_18_total", 2018, "2018 Governor - Total", "MN-shapefiles/MN16/mn_precincts16.shp", "gov_18_total", "13_21",
  
  # 2018 AG (use 2016 shapefile)
  "hilstrom18", 2018, "2018 AG - Hilstrom", "MN-shapefiles/MN16/mn_precincts16.shp", "hilstrom18_votes", "13_21",
  "ellison18", 2018, "2018 AG - Ellison", "MN-shapefiles/MN16/mn_precincts16.shp", "ellison18_votes", "13_21",
  "pelikan18", 2018, "2018 AG - Pelikan", "MN-shapefiles/MN16/mn_precincts16.shp", "pelikan18_votes", "13_21",
  "rothman18", 2018, "2018 AG - Rothman", "MN-shapefiles/MN16/mn_precincts16.shp", "rothman18_votes", "13_21",
  "foley18", 2018, "2018 AG - Foley", "MN-shapefiles/MN16/mn_precincts16.shp", "foley18_votes", "13_21",
  "ag_18_total", 2018, "2018 AG - Total", "MN-shapefiles/MN16/mn_precincts16.shp", "ag_18_total", "13_21",
  
  # 2018 CD5 (use 2016 shapefile)
  "omar18", 2018, "2018 CD5 - Omar", "MN-shapefiles/MN16/mn_precincts16.shp", "omar18_votes", "13_21",
  "kelliher18", 2018, "2018 CD5 - Kelliher", "MN-shapefiles/MN16/mn_precincts16.shp", "kelliher18_votes", "13_21",
  "ray18", 2018, "2018 CD5 - Ray", "MN-shapefiles/MN16/mn_precincts16.shp", "ray18_votes", "13_21",
  "ush_18_total", 2018, "2018 CD5 - Total", "MN-shapefiles/MN16/mn_precincts16.shp", "ush_18_total", "13_21",
  
  # 2020 Presidential Primary (use 2020 shapefile)
  "sanders20", 2020, "2020 Primary - Sanders", "mpls_precincts_2021/general_election_results_by_precinct_2020.shp", "sanders20_votes", "13_21",
  "warren20", 2020, "2020 Primary - Warren", "mpls_precincts_2021/general_election_results_by_precinct_2020.shp", "warren20_votes", "13_21",
  "biden20", 2020, "2020 Primary - Biden", "mpls_precincts_2021/general_election_results_by_precinct_2020.shp", "biden20_votes", "13_21",
  "bloomberg20", 2020, "2020 Primary - Bloomberg", "mpls_precincts_2021/general_election_results_by_precinct_2020.shp", "bloomberg20_votes", "13_21",
  "pres_20_total", 2020, "2020 Primary - Total", "mpls_precincts_2021/general_election_results_by_precinct_2020.shp", "pres_20_total", "13_21",
  
  # 2020 CD5 Primary (use 2020 shapefile)
  "omar20", 2020, "2020 CD5 Primary - Omar", "mpls_precincts_2021/general_election_results_by_precinct_2020.shp", "omar20_votes", "13_21",
  "ush_20_total", 2020, "2020 CD5 Primary - Total", "mpls_precincts_2021/general_election_results_by_precinct_2020.shp", "ush_20_total", "13_21",
  
  # 2021 Mayoral (use 2020 shapefile)
  "frey21", 2021, "2021 Mayoral - Frey", "mpls_precincts_2021/general_election_results_by_precinct_2020.shp", "frey21_votes", "13_21",
  "knuth21", 2021, "2021 Mayoral - Knuth", "mpls_precincts_2021/general_election_results_by_precinct_2020.shp", "knuth21_votes", "13_21",
  "nezhad21", 2021, "2021 Mayoral - Nezhad", "mpls_precincts_2021/general_election_results_by_precinct_2020.shp", "nezhad21_votes", "13_21",
  "mayor_21_total", 2021, "2021 Mayoral - Total", "mpls_precincts_2021/general_election_results_by_precinct_2020.shp", "mayor_21_total", "13_21",
  
  # 2021 Ballot Questions (use 2020 shapefile)
  "yes1_21", 2021, "2021 Question 1 - Yes", "mpls_precincts_2021/general_election_results_by_precinct_2020.shp", "yes1_votes", "13_21",
  "structure_21_total", 2021, "2021 Question 1 - Total", "mpls_precincts_2021/general_election_results_by_precinct_2020.shp", "structure_21_total", "13_21",
  "yes2_21", 2021, "2021 Question 2 - Yes", "mpls_precincts_2021/general_election_results_by_precinct_2020.shp", "yes2_votes", "13_21",
  "police_21_total", 2021, "2021 Question 2 - Total", "mpls_precincts_2021/general_election_results_by_precinct_2020.shp", "police_21_total", "13_21",
  "yes3_21", 2021, "2021 Question 3 - Yes", "mpls_precincts_2021/general_election_results_by_precinct_2020.shp", "yes3_votes", "13_21",
  "rent_21_total", 2021, "2021 Question 3 - Total", "mpls_precincts_2021/general_election_results_by_precinct_2020.shp", "rent_21_total", "13_21",
  
  # 2022 CD5 Primary (use 2025 shapefile - closest available for 2020s redistricting)
  "omar22", 2022, "2022 CD5 Primary - Omar", "mpls_precincts_2025/bdry_votingdistricts.shp", "omar22_votes", "22_25",
  "ush_22_total", 2022, "2022 CD5 Primary - Total", "mpls_precincts_2025/bdry_votingdistricts.shp", "ush_22_total", "22_25",
  
  # 2024 Presidential Primary (use 2025 shapefile)
  "biden24", 2024, "2024 Primary - Biden", "mpls_precincts_2025/bdry_votingdistricts.shp", "biden24_votes", "22_25",
  "uncommitted24", 2024, "2024 Primary - Uncommitted", "mpls_precincts_2025/bdry_votingdistricts.shp", "uncommitted24_votes", "22_25",
  "phillips24", 2024, "2024 Primary - Phillips", "mpls_precincts_2025/bdry_votingdistricts.shp", "phillips24_votes", "22_25",
  "pres_24_total", 2024, "2024 Primary - Total", "mpls_precincts_2025/bdry_votingdistricts.shp", "pres_24_total", "22_25",
  
  # 2024 CD5 Primary (use 2025 shapefile)
  "omar24", 2024, "2024 CD5 Primary - Omar", "mpls_precincts_2025/bdry_votingdistricts.shp", "omar24_votes", "22_25",
  "ush_24_total", 2024, "2024 CD5 Primary - Total", "mpls_precincts_2025/bdry_votingdistricts.shp", "ush_24_total", "22_25",
  
  # 2025 Mayoral (use 2025 shapefile)
  "frey25", 2025, "2025 Mayoral - Frey", "mpls_precincts_2025/bdry_votingdistricts.shp", "frey25_votes", "22_25",
  "fateh25", 2025, "2025 Mayoral - Fateh", "mpls_precincts_2025/bdry_votingdistricts.shp", "fateh25_votes", "22_25",
  "davis25", 2025, "2025 Mayoral - Davis", "mpls_precincts_2025/bdry_votingdistricts.shp", "davis25_votes", "22_25",
  "hampton25", 2025, "2025 Mayoral - Hampton", "mpls_precincts_2025/bdry_votingdistricts.shp", "hampton25_votes", "22_25",
  "mayor_25_total", 2025, "2025 Mayoral - Total", "mpls_precincts_2025/bdry_votingdistricts.shp", "mayor_25_total", "22_25"
)
...
election_results_13_21 <- tryCatch({
  df <- read_csv("election_results/election_results_13_21.csv", show_col_types = FALSE)
...
election_results_22_25 <- tryCatch({
  df <- read_csv("election_results/election_results_22_25.csv", show_col_types = FALSE)
  df <- df |> mutate(pct_name_normalized = normalize_precinct_name(pct_name))
...
write_csv(all_tract_results, "tract_election_results_all.csv")
cat("  Saved: tract_election_results_all.csv\n")

# Save block-level results
if (exists("block_results_combined")) {
  write_csv(block_results_combined, "block_election_results_all.csv")
  cat("  Saved: block_election_results_all.csv\n")
}
...
# Save as GeoPackage
st_write(tract_sf, "mpls_tract_all_elections.gpkg", delete_dsn = TRUE, quiet = TRUE)
cat("  Saved: mpls_tract_all_elections.gpkg\n")

# Save as shapefile (column names will be truncated)
if (!dir.exists("tract_election_shapefiles")) {
  dir.create("tract_election_shapefiles")
}
st_write(tract_sf |> select(1:30), "tract_election_shapefiles/mpls_tract_all_elections.shp", 
         delete_layer = TRUE, quiet = TRUE)
cat("  Saved: tract_election_shapefiles/mpls_tract_all_elections.shp\n")
...
cat("  - tract_election_results_all.csv (all elections at tract level)\n")
cat("  - block_election_results_all.csv (all elections at block level)\n")
cat("  - mpls_tract_all_elections.gpkg (GeoPackage with all data)\n")
cat("  - tract_election_shapefiles/mpls_tract_all_elections.shp\n")
